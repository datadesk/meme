...
MEME.MemeModel = Backbone.Model.extend({
  defaults: {
    ...
    textAlignVertical: 'Align bottom',
    textAlignVerticalOpts: ['Align top', 'Align middle', 'Align bottom'],
    textShadow: true,
    textShadowEdit: true,
    headUppercase: false,
    sourceUppercase: false,
    textUppercaseEdit: false,
    watermarkAlpha: 0.75,
